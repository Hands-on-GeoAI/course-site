...
We will send an invitation link for all enrolled students to the Slack Team called ``hands-ongeoai2026``.
...
**After accepting the invitation, you can access the course Slack team via this link:** `<http://hands-ongeoai2026.slack.com>`__
...
1. **You should always select the right channel for your question!**
 ...
 - If you want to share a funny GIF you found online, you can post it into channel ``social``.
