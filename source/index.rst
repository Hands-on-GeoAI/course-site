...
.. important::
    ...
    **Registration deadline:** 12th March 2026 via `this form <https://forms.gle/rgCkE3tTLuc2PW9p6>`__.
    Teaching sessions for Aalto students are held in Otakaari 4.

Learning objectives
-------------------

After completing this course, you should be able to understand and apply:

- Machine & Deep Learning in GeoAI
- GeoAI in Image Processing
- LLMs & Foundation Models
- Handling GeoBias, Fairness & Representativeness
- Real-world GeoAI Applications & State-of-the-Art Trends

Prerequisites (Unofficial)
--------------------------

Before taking this course, you should have:

1. **Programming in Python for GIS**
...
For Aalto students wanting to earn credits (5 ECTS) for basics, consider the *Geo-Python* and *Automating GIS-processes* courses available at `geo-python.github.io <http://geo-python.github.io/>`__ and `autogis.github.io <https://autogis.github.io/>`__.
...
.. admonition:: Help improving the materials
    ...
    **This is a new joint course.**
    ...
    ``suggest edit`` under the GitHub icon located at the top-right on each page.
...
The course consists of Lecture/Practical (VU) sessions. 

Key components of our technical ecosystem include:
...
- **Hands-on Practicals:** Focus on applying the introduced methods to real-world datasets.
...
.. admonition:: University Specifics & Credits
    ...
    **Aalto University Students:** Special course on Geoinformatics under the Master's Programme of Geoinformatics.
